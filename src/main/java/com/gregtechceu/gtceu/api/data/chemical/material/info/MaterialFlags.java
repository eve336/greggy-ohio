...
public class MaterialFlags {
    ...
    /**
     * Add to a material to disable autogenerated extractor recipes.
     */
    public static final MaterialFlag NO_EXTRACTING = new MaterialFlag.Builder("no_extracting")
            .build();

    /**
     * Add to a material to disable autogenerated fluid solidifier recipes.
     */
    public static final MaterialFlag NO_SOLIDIFYING = new MaterialFlag.Builder("no_solidifying")
            .build();
